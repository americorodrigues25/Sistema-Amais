...
<head>
    ...
    <title>Consultar Artista Amais</title>
...
if (!empty($_GET['search'])) {
    $dados = $_GET['search'];
    $query = "SELECT * FROM artista where nome like '%$dados%'";
                            ...
                            <div class="d-flex justify-content-center">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="../scripts/atualizar_artista_amais.php" method="post">
                                                    <fieldset>
                                                        <legend>Dados pessoais</legend>
                                                        <input type="text" name="id" value="<?php echo $linha["id"] ?>"
                                                            hidden>
                                                        ...
                                                        <select id="genero" name="genero">
                                                            ...
                                                            <option value="masculino" <?php if ($linha["genero"] == "masculino")
                                                                ...
                                                                <option value="outro" <?php if ($linha["genero"] == "masculino")
                                                                echo "outro" ?>>Outro
                                                                </option>
                                                                <option value="nao-informar" <?php if ($linha["genero"] == "masculino")
                                                                echo "nao-informar" ?>>
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Deletar artista</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">Voltar</button>
                                                <a
                                                    href="../scripts/deletar_artista_amais.php?id=<?php echo $linha['id'] ?>">
