...
<body>
    ...
    <div class="container-geral">
        ...
        <div class="button">
            <a href="cadastrar_prof&aluno_shakese.php"><button>Cadastrar Dançarino | Professor</button></a>
            <a href="consultar_dancarino_shakese.php"><button>Consultar Dançarino</button></a>
            <a href="consultar_professor_shakese.php"><button>Consultar Professor</button></a>
        </div>
    </div>
