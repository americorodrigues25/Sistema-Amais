...
<head>
    ...
    <title>Consultar Professor Shakese</title>
    ...
    if (!empty($_GET['search'])) {
        $dados = $_GET['search'];
        $query = "SELECT * FROM professor where nome like '%$dados%'";
                            ...
                            <div class="d-flex justify-content-center">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="../scripts/atualizar_professor_shakese.php" method="post">
                                                    <fieldset>
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Deletar professor</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">Voltar</button>
                                                <a
                                                    href="../scripts/deletar_professor_shakese.php?id=<?php echo $linha['id'] ?>">
