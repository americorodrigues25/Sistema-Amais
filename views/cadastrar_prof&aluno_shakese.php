...
<head>
    ...
    <link rel="icon" type="image/png" href="../img/Logo Pink melhor (PNG).png">
    <title>Cadastrar Professor | Dançarino shakese</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <img src="../img/Logo Pink melhor (PNG).png" alt="LOGO SKAKESE">
    <h2>Cadastrar Professor | Dançarino</h2>
    <?php
    ...
    } else if (isset($_SESSION["statusruim"])) {
        ?>
            <div class="alert-ruim">
    ...
    <div class="container-form">
        <form action="../scripts/cadastro_prof&aluno_shakese.php" method="post">
            <fieldset>
                <legend>Tipo de cadastro</legend>
                <input type="radio" name="tipo_usuario" value="professor" required>
                <label for="professor">Professor</label><br>
                <input type="radio" name="tipo_usuario" value="aluno" required>
                <label for="aluno">Dançarino</label><br>
            </fieldset>
            <fieldset>
