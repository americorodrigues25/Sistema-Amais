...
<head>
    ...
    <title>Consultar Cliente Amais</title>
...
if (!empty($_GET['search'])) {
    $dados = $_GET['search'];
    $query = "SELECT * FROM cliente where nome like '%$dados%'";
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="../scripts/atualizar_cliente_amais.php" method="post">
                                                    <fieldset>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">Voltar</button>
                                                <a
                                                    href="../scripts/deletar_cliente_amais.php?id=<?php echo $linha['id'] ?>">
